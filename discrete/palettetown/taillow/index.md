...
```r
library(paletteer)
paletteer_d("palettetown::taillow")
```

Use raw:

```r
c("#F8F8F8FF", "#283058FF", "#5868A8FF", "#485890FF", "#C8D0D0FF", "#000000FF", "#909090FF", "#785858FF", "#803850FF", "#C03030FF", "#E0B848FF", "#F8E850FF", "#7888C8FF", "#E06860FF", "#F89088FF")
``` 
