...
```r
library(paletteer)
paletteer_d("palettetown::houndoom")
```

Use raw:

```r
c("#504848FF", "#383030FF", "#887878FF", "#B0A0A0FF", "#F8F8F8FF", "#E8A050FF", "#282020FF", "#B87838FF", "#905018FF", "#F8D088FF", "#B03008FF", "#F86830FF")
``` 
...
<a href="../../beyonce/X79/"> <img src="../../beyonce/X79/featured.svg" style="width: 100%;" class="figure-img"></a>
</figure> 
</div>
