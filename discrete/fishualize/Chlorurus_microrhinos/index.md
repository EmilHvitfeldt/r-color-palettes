...
# fishualize - Chlorurus_microrhinos 
...
```r
library(paletteer)
paletteer_d("fishualize::Chlorurus_microrhinos")
```

Use raw:

```r
c("#623DBFFF", "#1664FFFF", "#0EE6F9FF", "#14B8CEFF", "#14AA62FF")
``` 
