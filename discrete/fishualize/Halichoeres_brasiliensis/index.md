...
image: featured.svg
package: fishualize
palette: Halichoeres_brasiliensis
length: 5
type: sequential
novelty: Novelty - Yes
categories:
...
# fishualize - Halichoeres_brasiliensis 
...
```r
library(paletteer)
paletteer_d("fishualize::Halichoeres_brasiliensis")
```

Use raw:

```r
c("#056CF2FF", "#0583F2FF", "#05AFF2FF", "#05C7F2FF", "#05DBF2FF")
``` 
