...
```r
library(paletteer)
paletteer_d("vapeplot::crystal_pepsi")
```

Use raw:

```r
c("#FFCCFFFF", "#F1DAFFFF", "#E3E8FFFF", "#CCFFFFFF")
``` 
...
<a href="../../vapoRwave/crystalPepsi/"> <img src="../../vapoRwave/crystalPepsi/featured.svg" style="width: 100%;" class="figure-img"></a>
</figure> <figure class="figure">
...
<a href="../../unikn/pal_peach/"> <img src="../../unikn/pal_peach/featured.svg" style="width: 100%;" class="figure-img"></a>
</figure> <figure class="figure">
