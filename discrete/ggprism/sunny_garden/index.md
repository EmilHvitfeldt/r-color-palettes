...
```r
library(paletteer)
paletteer_d("ggprism::sunny_garden")
```

Use raw:

```r
c("#008000FF", "#8B4513FF", "#6699CCFF", "#8B4513FF", "#33CC00FF", "#008000FF", "#CC9900FF", "#FFCC00FF", "#FFCC00FF")
``` 
