...
```r
library(paletteer)
paletteer_d("ggprism::wool_muffler")
```

Use raw:

```r
c("#6699CCFF", "#6699CCFF", "#FF9933FF", "#4169E1FF", "#87CEFAFF", "#FF6600FF", "#CCCCFFFF", "#6699CCFF", "#FF6600FF")
``` 
