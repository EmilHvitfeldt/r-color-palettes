...
```r
library(paletteer)
paletteer_d("dichromat::BluetoOrange_10")
```

Use raw:

```r
c("#0055FFFF", "#3399FFFF", "#66CCFFFF", "#99EEFFFF", "#CCFFFFFF", "#FFFFCCFF", "#FFEE99FF", "#FFCC66FF", "#FF9933FF", "#FF5500FF")
``` 
