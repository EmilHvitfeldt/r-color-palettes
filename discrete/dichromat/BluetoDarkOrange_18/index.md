...
```r
library(paletteer)
paletteer_d("dichromat::BluetoDarkOrange_18")
```

Use raw:

```r
c("#006666FF", "#009999FF", "#00CCCCFF", "#00FFFFFF", "#33FFFFFF", "#66FFFFFF", "#99FFFFFF", "#B2FFFFFF", "#CCFFFFFF", "#E6FFFFFF", "#FFE6CCFF", "#FFCA99FF", "#FFAD66FF", "#FF8F33FF", "#FF6E00FF", "#CC5500FF", "#993D00FF", "#662700FF")
``` 
...
<a href="../../colorBlindness/Blue2DarkOrange18Steps/"> <img src="../../colorBlindness/Blue2DarkOrange18Steps/featured.svg" style="width: 100%;" class="figure-img"></a>
</figure> <figure class="figure">
