...
```r
library(paletteer)
paletteer_d("ggsci::purple_tw3")
```

Use raw:

```r
c("#FAF5FFFF", "#F3E8FFFF", "#E9D5FFFF", "#D8B4FEFF", "#C084FCFF", "#A855F7FF", "#9333EAFF", "#7E22CEFF", "#6B21A8FF", "#581C87FF", "#3B0764FF")
``` 
...
<a href="../../ggsci/violet_tw3/"> <img src="../../ggsci/violet_tw3/featured.svg" style="width: 100%;" class="figure-img"></a>
</figure> <figure class="figure">
