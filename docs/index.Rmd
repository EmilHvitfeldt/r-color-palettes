...
<div class="w-full mx-auto py-24 bg-cover flex-grow" style="background-image: url('https://products.ls.graphics/mesh-gradients/images/33.-Beauty-Bush.jpg')">

<div class="max-w-6xl py-24 mx-auto">


<div class="mx-auto max-w-4xl bg-white bg-white backdrop-filter backdrop-blur-lg bg-opacity-40 my-4 px-8 py-8 shadow-lg sm:rounded-lg border-y-2 sm:border-x-2 border-gray-100 prose">
...
This site was designed by [Kyle Butts](twitter.com/kylebutts).
